...
" COC configuration
" 
"let g:coc_global_extensions = ['coc-lua', 'coc-rls', 'coc-snippets', 'coc-emmet', 'coc-html', 'coc-eslint', 'coc-prettier', 'coc-tailwindcss', 'coc-yaml', 'coc-json', 'coc-deno', 'coc-jedi']
"
